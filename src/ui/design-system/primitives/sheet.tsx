...
/** @public Part of the Sheet primitive surface; consumers may import to render an explicit close button. */
  ...
  "fixed z-50 gap-4 bg-card p-6 shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        ...
        full: "inset-0 h-full w-full border-none data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
      },
    },
    defaultVariants: {
      side: "right",
